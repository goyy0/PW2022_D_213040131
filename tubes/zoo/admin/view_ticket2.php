        ...
        {?>
          ...
          <table border="1" class="table table-striped table-bordered first" >
            ...
            <tr>
              ...
              <td style="padding-left: 10px">Rp.<?php  echo $cup=$row->AdultUnitprice;?></td>
              <td style="padding-left: 10px">Rp.<?php  echo $ta=$cup*$noadult;?></td>
            </tr>
            <tr>
              <th>Number of Chlidren </th>
              <td style="padding-left: 10px"><?php  echo $nochild=$row->NoChildren ;?></td>
              <td style="padding-left: 10px">Rp.<?php  echo $aup=$row->ChildUnitprice ;?></td>
              <td style="padding-left: 10px">Rp.<?php  echo $tc=$aup*$nochild;?></td>
            </tr>

            <tr>
              <th style="text-align: center;color: red;font-size: 20px" colspan="3">Total Ticket Price</th>
              <td style="padding-left: 10px;">Rp.<?php  echo ($ta+$tc);?></td>
            </tr>
          </table>
          <?php 
        }
